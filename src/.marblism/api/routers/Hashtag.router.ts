...
export default function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        createMany: procedure.input($Schema.HashtagInputSchema.createMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).hashtag.createMany(input as any))),
        ...
        deleteMany: procedure.input($Schema.HashtagInputSchema.deleteMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).hashtag.deleteMany(input as any))),
        ...
        findFirst: procedure.input($Schema.HashtagInputSchema.findFirst).query(({ ctx, input }) => checkRead(db(ctx).hashtag.findFirst(input as any))),

        findMany: procedure.input($Schema.HashtagInputSchema.findMany).query(({ ctx, input }) => checkRead(db(ctx).hashtag.findMany(input as any))),
